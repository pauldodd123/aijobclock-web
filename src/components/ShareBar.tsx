...
const platforms = [
  {
    name: 'X',
    icon: () => (
      <svg viewBox="0 0 24 24" className="h-4 w-4 fill-current" aria-label="X (Twitter)" role="img">
  ...
  },
  {
    name: 'LinkedIn',
    icon: () => (
      <svg viewBox="0 0 24 24" className="h-4 w-4 fill-current" aria-label="LinkedIn" role="img">
  ...
  },
  {
    name: 'Reddit',
    icon: () => (
      <svg viewBox="0 0 24 24" className="h-4 w-4 fill-current" aria-label="Reddit" role="img">
